...
class ReadSampleSheet(object):
    ...
    def __init__(self) -> None:
        ...
        parser.add_argument("command", help="Subcommand to run. Choice from {}.".format(RECOGNIZED_COMMANDS))
    ...
    def read(self):
        ...
        parser = argparse.ArgumentParser(description="Read samplesheet and correct paths where needed.")
    ...
    def write(self):
        ...
        parser = argparse.ArgumentParser(description="Read samplesheet, update to absolute paths and store in db.")
        parser.add_argument("-s", "--samplesheet", default=CORR_SAMPLESHEET)
